 ...
 * Classe da chave prim�ria da entidade PessoaDependente
 * 
...
public class PessoaDependentePK implements Serializable {
    ...
    public String toString() {
        return "com.java.model.PessoaDependentePK[ nrMatricula=" + nrMatricula + ", nrSequencial=" + nrSequencial + ", cdCorporacao=" + cdCorporacao + " ]";
    }
